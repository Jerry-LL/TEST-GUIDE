        ...
        if srcType in [u'UTILITY', u'UNDEFINED', u'PACKAGE', u'PARALLEL_PACKAGE', u'CALL']:
            ...
            if srcType == u'UNDEFINED':
                ...
                if (u":BLOCK" in cmpSubSrcType or
                    ...
                    if info:
                        args[u'verdictDefinition'] = info
                elif u":MULTI-CHECK" in cmpSubSrcType:
                    args[u'longName'] = u"Multi-Check"
                    if info:
                        args[u'verdictDefinition'] = info
                elif cmpName == _(u'Analyse-Job').upper():
                ...
                if pkg.GetActivity().startswith('SWK -> TA'):
                    return  # Hier wird kein Package aufgerufen
